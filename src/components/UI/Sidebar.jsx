...
const Sidebar = ({ value, handleChange }) => {
    ...
    return (
        <Grid id="Gr" item md={3} sx={{ backgroundColor: "gray.main", padding: "2rem", display: { xs: "none", md: "block" } }} color={grey[100]}>
            ...
            <Typography variant="caption" sx={{ textAlign: "center" }} color={grey[500]}>توسعه دهنده فول استک وب (۲و۳) </Typography>
            <br />
