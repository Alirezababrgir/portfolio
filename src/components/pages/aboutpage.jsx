...
const About = () => {
    return (
        <>
            ...
            <Box sx={{ height: "55%", width: "90%", margin: " 0 auto", display: "flex", justifyContent: "center", flexDirection: "row-reverse", alignItems: "center" }}>
                <Card sx={{ maxWidth: 345,p:2, mx: 4, backgroundColor: "silver",borderRadius:"2rem" }}>
                    <CardActionArea>
                        <CardMedia
