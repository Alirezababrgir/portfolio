    ...
    return (
        ...
        <>
            ...
            <Box sx={{ p: 3,height:"20vh" }}>
                ...
                <Divider variant="middle" textAlign="right" sx={{ mt: 2, mb: 1, "&::before,&::after": { borderColor: "black" } }}><Slide direction="down" in={load} style={{ transitionDelay: load ? '1000ms' : '0ms' }}><Chip color="info" sx={{ color: "black" }} label=" سلام" variant="outlined" /></Slide></Divider>
            </Box>
