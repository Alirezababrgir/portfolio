...
const Sidebar = ({ handleChange }) => {
    return (
        <Grid id="Gr" item md={3} sx={{backgroundColor: "#7777", padding: "1.4rem", display: { xs: "none", md: "block" }, borderRight: "4px solid silver",mx:0, borderBottom: "4px solid silver", borderRadius: "4px" ,overflowY:"auto"}} color={grey[100]}>
