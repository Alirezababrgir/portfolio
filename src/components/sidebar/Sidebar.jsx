...
const Sidebar = ({ handleChange }) => {
    return (
        <Grid id="Gr" item md={3} sx={{backgroundColor: "gray.main", padding: "1.4rem", display: { xs: "none", md: "block" }, borderRight: "4px solid silver", borderBottom: "4px solid silver", borderRadius: "4px" ,overflowY:"auto"}} color={grey[100]}>
